...
wp.customize( 'login_customizer_options[logincust_templates_control]', function( setting ) {
	setting.bind( function( value ) {
		if ( value === 'original' ) {
		...
		else if ( value === 'customtheme' ) {
			resetOptions( allOptions, allValues );
			changeValue( 'login_customizer_options[logincust_bg_image]', logincust_script.url + 'Customizer/Templates/customtheme/assets/material.jpg' );
			changeValue( 'login_customizer_options[logincust_logo]', logincust_script.url + 'Customizer/Templates/customtheme/assets/logo.png' );
			changeValue( 'login_customizer_options[logincust_form_bg_color]', '#dbc777' );
			changeValue( 'login_customizer_options[logincust_form_shadow_spread]', '0px' );
			changeValue( 'login_customizer_options[logincust_form_shadow]', 'rgba(0,0,0,0.0)' );
			changeValue( 'login_customizer_options[logincust_field_bg]', '#222' );
			changeValue( 'login_customizer_options[logincust_field_radius]', '5px' );
		...
		else if ( value === 'customtheme2' ) {
			resetOptions( allOptions, allValues );
			changeValue( 'login_customizer_options[logincust_logo]', logincust_script.url + 'Customizer/Templates/customtheme2/assets/logo.png' );
			changeValue( 'login_customizer_options[logincust_bg_image]', logincust_script.url + 'Customizer/Templates/customtheme2/assets/material.jpg' );
			changeValue( 'login_customizer_options[logincust_form_bg_color]', '#fff' );
			changeValue( 'login_customizer_options[logincust_form_shadow_spread]', '0px' );
			changeValue( 'login_customizer_options[logincust_form_shadow]', 'rgba(0,0,0,0.0)' );
			changeValue( 'login_customizer_options[logincust_field_bg]', '#222' );
			changeValue( 'login_customizer_options[logincust_field_radius]', '5px' );
			...
			changeValue( 'login_customizer_options[logincust_field_color]', '#777' );
			changeValue( 'login_customizer_options[logincust_field_padding]', '3px 10px 3px 10px' );
			changeValue( 'login_customizer_options[logincust_button_bg]', '#000' );
			changeValue( 'login_customizer_options[logincust_button_hover_bg]', '#e2e2e2' );
			changeValue( 'login_customizer_options[logincust_button_color]', '#fff' );
			changeValue( 'login_customizer_options[logincust_button_border_width]', '0px' );
			changeValue( 'login_customizer_options[logincust_button_text_shadow]', '#fff' );
			changeValue( 'login_customizer_options[logincust_other_color]', '#777' );
			changeValue( 'login_customizer_options[logincust_other_color_hover]', '#e91e63' );
