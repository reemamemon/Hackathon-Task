...
class Templates extends Sanitizers{
	...
	function __construct( $wp_customize ) {
		...
		$free_templates = array(
			...
			'customtheme'	=> LOGINCUST_FREE_URL . 'Customizer/Templates/customtheme/assets/material.png',
			'customtheme2'	=> LOGINCUST_FREE_URL . 'Customizer/Templates/customtheme2/assets/material.png',
		);
